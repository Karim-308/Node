...
const { checkToken, verifyOwnership } = require("../middleware/auth");
const { getStatus } = require("../lib/helpers");
...
router.patch("/:id", checkToken, verifyOwnership, async (req, res) => {
    try {
...
router.delete("/:id", checkToken, verifyOwnership, async (req, res) => {
    try {
...
router.patch("/:id/stock", checkToken, verifyOwnership, async (req, res) => {
    try {
